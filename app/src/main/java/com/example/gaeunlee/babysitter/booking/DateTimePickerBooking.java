 ...
 *
 */
public class DateTimePickerBooking extends LinearLayout {
    /**
     * 날짜나 시간이 바뀔 때 호출되는 리스너 새로 정의
     */
    public interface OnDateTimeChangedListener {
        void onDateTimeChanged(DateTimePickerBooking view, int year, int monthOfYear, int dayOfYear, int hourOfDay, int minute);
    }
    ...
    private final CheckBox enableTimeCheckBox2;
    ...
    private final TimePicker timePicker2;
     ...
     * @param context
     */
    public DateTimePickerBooking(final Context context){
        this(context, null);
    }
     ...
     * @param attrs
     */
    public DateTimePickerBooking(Context context, AttributeSet attrs){
        super(context, attrs);

        // XML 레이아웃을 인플레이션함
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.datetimepicker_booking, this, true);
            ...
            public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                if(onDateTimeChangedListener != null){
                    onDateTimeChangedListener.onDateTimeChanged(
                            DateTimePickerBooking.this, year, monthOfYear, dayOfMonth,
        ...
        // 체크박스2 이벤트 처리
        enableTimeCheckBox2 = (CheckBox)findViewById(R.id.enableTimeCheckBox2);
        enableTimeCheckBox2.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {


                timePicker2.setEnabled(isChecked);
                timePicker2.setVisibility((enableTimeCheckBox2).
                        isChecked()? View.VISIBLE : View.INVISIBLE);
        ...
        timePicker.setOnTimeChangedListener(new OnTimeChangedListener() {
            public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
                ...
                if(onDateTimeChangedListener != null) {
                    ...
                    onDateTimeChangedListener.onDateTimeChanged(
                            DateTimePickerBooking.this, datePicker.getYear(),
        ...
        timePicker2.setCurrentHour(_currentHour);
        timePicker2.setCurrentMinute(_currentMinute);
        timePicker2.setEnabled(enableTimeCheckBox2.isChecked());
        timePicker2.setVisibility((enableTimeCheckBox2.isChecked()? View.VISIBLE: View.INVISIBLE));
    ...
    public void setIs24HourView(final boolean is24HourView){
        ...
        timePicker2.setIs24HourView(is24HourView);
