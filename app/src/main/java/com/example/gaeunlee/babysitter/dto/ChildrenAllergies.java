...
public class ChildrenAllergies {
    ...
    public ChildrenAllergies() {
    }

    public ChildrenAllergies(String email, String password, String first_name, String last_name, Timestamp reg_date) {
        this.email = email;
        this.password = password;
        this.first_name = first_name;
        this.last_name = last_name;
